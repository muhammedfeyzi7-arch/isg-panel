...
export default function PersonelDetayModal({ personelId, onClose }: Props) {
  const {
    personeller, firmalar, evraklar, egitimler, muayeneler, uygunsuzluklar,
  } = useApp();
            ...
            {pMuayeneler.length === 0 && pSaglikEvraklar.length === 0
              ? (
                ...
                <>
                        ...
                        <ListRow
                          ...
                          badge={
                            <Badge
                              label={m.sonuc}
                              color={
                                m.sonuc === 'Çalışabilir' ? 'green'
                                  : m.sonuc === 'Kısıtlı Çalışabilir' ? 'amber'
                                    : 'red'
                              }
                            />
                          }
                  ...
                  {/* Sağlık Belgeleri (EK-2, Sağlık Raporu vb.) */}
