  ...
  const statCards = [
    {
      ...
      iconShadow: '0 8px 20px rgba(99,102,241,0.3)',
      valueColor: 'linear-gradient(135deg, #60A5FA, #818CF8)',
    },
    {
      ...
      iconShadow: '0 8px 20px rgba(16,185,129,0.3)',
    ...
    },
    {
      ...
      iconShadow: '0 8px 20px rgba(239,68,68,0.3)',
      valueColor: 'linear-gradient(135deg, #FCA5A5, #F87171)',
    },
    {
...
function DashEmptyState({
  icon, text, subtext, color = '#475569',
}: {
