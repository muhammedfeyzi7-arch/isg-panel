    ...
    <>
      <header
        ...
        style={{
          ...
          borderRadius: '14px',
          boxShadow: isDark ? '0 4px 20px rgba(0,0,0,0.25), 0 1px 4px rgba(0,0,0,0.1)' : '0 4px 20px rgba(15,23,42,0.10), 0 1px 4px rgba(15,23,42,0.06), 0 0 0 1px rgba(15,23,42,0.06)',
      ...
      >
        ...
        <div className="flex items-center gap-1.5 flex-shrink-0">
          <div className="w-7 h-7 flex items-center justify-center rounded-lg flex-shrink-0"
            ...
            <i className={`${meta.icon} text-[12px]`} style={{ color: ACCENT }} />
          </div>
          <span className="text-[13px] sm:text-[14px] font-bold truncate" style={{ color: nameColor, maxWidth: '160px' }}>
            {meta.label}
          </span>
        </div>
        ...
        <div className="relative flex-shrink-0 hidden sm:block" ref={supportNotifRef}>
          ...
          {supportNotifOpen && (
            <div
              className="absolute right-0 top-12 z-50 w-[300px] sm:w-[320px] overflow-hidden"
