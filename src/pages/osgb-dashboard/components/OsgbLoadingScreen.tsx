...
const STEPS = [
  ...
  { label: 'OSGB verileri yükleniyor...', icon: 'ri-building-2-line', duration: 700 },
  { label: 'Firmalar hazırlanıyor...', icon: 'ri-store-2-line', duration: 700 },
  { label: 'Uzmanlar yükleniyor...', icon: 'ri-user-star-line', duration: 600 },
