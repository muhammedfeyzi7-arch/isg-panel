              ...
              >
                ...
                <td className="px-4 py-4 whitespace-nowrap">
                  {days === null ? (
                    ...
                    <span className="text-red-500 text-xs font-bold">{Math.abs(days)}g geçti</span>
                  ) : days <= 7 ? (
                    <span className="text-red-500 text-xs font-bold">{days}g</span>
                  ) : days <= 30 ? (
                    <span className="text-amber-600 text-xs font-semibold">{days}g</span>
                  ) : (
                    <span className="text-slate-500 text-xs font-medium">{days}g</span>
                  )}
                </td>
