  ...
  return (
    ...
    >
          ...
          <div className="flex-1 flex flex-col items-center justify-center text-center">
            ...
            <div style={{ maxWidth: '340px' }}>
              ...
              <p className="text-sm leading-relaxed" style={{ color: '#6aacbf' }}>
                Firmalar, OSGB'ler ve uzmanlar — tüm operasyonlarınızı tek panelden takip edin.
              </p>
            </div>
      ...
      >
        ...
        <div className="relative z-10 max-w-[380px] w-full mx-auto fade-in">
          {/* Header */}
          <div className="mb-8">
            <div
          ...
          <div className="mt-8 grid grid-cols-3 gap-3">
            {[
              ...
              { icon: 'ri-cloud-line', label: 'Bulut Tabanlı', color: '#0891B2' },
            ].map((b) => (
              <div
                key={b.label}
