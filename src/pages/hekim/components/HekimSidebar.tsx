        ...
        >
          ...
          {!collapsed && (
            <div className="flex-1 min-w-0">
              ...
              <p className="text-[9.5px] font-semibold mt-0.5 truncate" style={{ color: '#0EA5E9', letterSpacing: '0.04em' }}>
                HEKİM PANELİ
              </p>
            </div>
          )}
          ...
          <div className="mx-3 mt-3">
            ...
            >
              <div className="flex items-center gap-2">
                <div className="w-1.5 h-1.5 rounded-full flex-shrink-0" style={{ background: '#0EA5E9', boxShadow: '0 0 5px rgba(14,165,233,0.6)' }} />
                <p className="text-[9px] font-bold uppercase tracking-[0.12em]" style={{ color: 'rgba(14,165,233,0.65)' }}>
                  Organizasyon
                </p>
              </div>
              <p className="text-[12px] font-bold mt-1 truncate" style={{ color: '#0EA5E9' }}>{orgName}</p>
            </div>
          </div>
        )}
              ...
              >
                {isActive && !collapsed && (
                  <span
                    ...
                    style={{ width: '3px', height: '55%', background: 'linear-gradient(180deg, #38BDF8, #0284C7)', boxShadow: '0 0 6px rgba(14,165,233,0.4)' }}
                  />
                )}
                <span
                ...
                >
                  <i
                    ...
                    style={{
                      color: isActive ? '#0EA5E9' : isHovered ? 'var(--text-secondary)' : 'var(--text-faint)',
                ...
                {!collapsed && (
                  <span
                    ...
                    style={{
                      color: isActive ? '#0EA5E9' : isHovered ? 'var(--text-primary)' : 'var(--text-muted)',
                ...
                {!collapsed && isActive && (
                  <span className="w-1.5 h-1.5 rounded-full flex-shrink-0" style={{ background: '#0EA5E9', boxShadow: '0 0 5px rgba(14,165,233,0.6)' }} />
                )}
              </button>
            );
          })}
        ...
        <div className={`px-2.5 pb-2 ${collapsed ? 'flex justify-center' : ''}`}>
          ...
          >
            <div className="w-5 h-5 flex items-center justify-center flex-shrink-0">
              <i className="ri-customer-service-2-line text-xs" style={{ color: '#0EA5E9' }} />
            </div>
            {!collapsed && (
              <>
                <span className="text-[11.5px] font-semibold flex-1 text-left" style={{ color: '#0EA5E9' }}>Destek</span>
            ...
            <>
              <div className="flex-1 min-w-0">
                ...
                <div className="flex items-center gap-1 mt-0.5">
                  <span className="w-1.5 h-1.5 rounded-full" style={{ background: '#0EA5E9', boxShadow: '0 0 4px rgba(14,165,233,0.6)' }} />
                  <p className="text-[9.5px] font-semibold" style={{ color: '#0EA5E9' }}>İşyeri Hekimi</p>
                </div>
              </div>
              <button
                onClick={logout}
